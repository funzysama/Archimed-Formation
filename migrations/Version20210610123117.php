 ...
 */
final class Version20210610123117 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_1D1C63B3D628E802 ON utilisateur');
        $this->addSql('DROP INDEX IDX_1D1C63B35C62FBDA ON utilisateur');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_1D1C63B3D628E802 ON utilisateur (resultat_riasec_id)');
        $this->addSql('CREATE INDEX IDX_1D1C63B35C62FBDA ON utilisateur (resultat_i3_p_id)');
    }
}
